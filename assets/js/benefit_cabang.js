var addBtn = $("#add-btn"),
    loadData = window.base_url + "benefit_cabang/load_data",
    tableID = $("#datatable_ajax"),
    grid = new Datatable,
    urlUpdateStatus = window.base_url + "benefit_cabang/delete",
    Page = function() {
        return {
            init: function() {
            ...
            submitForm: function(e, a) {
                if (confirm("Are you sure ?")) {
                    ...
                    if (Helper.validateForm(e, {
                        ...
                        var t = Helper.baseUrl("benefit_cabang/add");
                        a && (t = Helper.baseUrl("benefit_cabang/edit")), 
            ...
            add: function(e) {
                ...
                i.text("Add Data payment"), Helper.blockElement($(a)), Helper.ajax(Helper.baseUrl("benefit_cabang/load_payment_form"), "get", "html").error(function(a) {
                    e.find(".close").click()
                }).done(function(e) {
            ...
            edit: function(e) {
                ...
                t.text("Edit Data Hotel"), Helper.blockElement($(i)), Helper.ajax(Helper.baseUrl("benefit_cabang/load_edit_form"), "get", "html", {
                    id:e
                }).error(function(e) {
                    a.find(".close").click()
                }).done(function(e) {
            ...
            payment: function(e) {
                var a = Helper.loadModal("lg"),
                    i = a.find(".modal-body"),
                    t = a.find(".modal-title");
                t.text("Payment"), Helper.blockElement($(i)), Helper.ajax(Helper.baseUrl("benefit_cabang/load_payment_form"), "get", "html", {
                    id:e
                }).error(function(e) {
                    a.find(".close").click()
                }).done(function(e) {
            ...
            export: function() {
                ...
                Helper.ajax(Helper.baseUrl('benefit_cabang/load_export'), 'get', 'html')
