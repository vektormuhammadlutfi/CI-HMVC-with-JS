var addBtn = $("#add-btn"),
    loadData = window.base_url + "schedule_group_movement/load_data",
    tableID = $("#datatable_ajax"),
    grid = new Datatable,
    urlUpdateStatus = window.base_url + "schedule_group_movement/delete",
    Page = function() {
        return {
            init: function() {
            ...
            submitForm: function(e, a) {
                ...
                if (Helper.validateForm(e, {
                    ...
                    var t = Helper.baseUrl("schedule_group_movement/add");
                    a && (t = Helper.baseUrl("schedule_group_movement/edit")), Helper.blockElement(e.parent()), i.attr("disabled", !0), Helper.ajax(t, "post", "json", Helper.serializeForm(e)).error(function(a) {
            ...
            add: function() {
                ...
                i.text("Add Data schedule_group_movement"), Helper.blockElement($(a)), Helper.ajax(Helper.baseUrl("schedule_group_movement/load_add_form"), "get", "html").error(function(a) {
                    e.find(".close").click()
                }).done(function(e) {
            ...
            edit: function(e) {
                ...
                window.location.href = Helper.baseUrl("group_movement/schedule/") + e;
