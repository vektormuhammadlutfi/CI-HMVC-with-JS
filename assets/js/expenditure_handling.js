var addBtn = $("#add-btn"),
    loadData = window.base_url + "expenditure_handling/load_data",
    tableID = $("#datatable_ajax"),
    grid = new Datatable,
    urlUpdateStatus = window.base_url + "expenditure_handling/delete",
    Page = function() {
        return {
            init: function() {
            ...
            submitForm: function(form, id) {
                if (confirm("Are you sure ?")) {
                    ...
                    if (form.valid()) {
                        ...
                        var url = Helper.baseUrl('expenditure_handling/add');

                        if (id) {
                            url = Helper.baseUrl('expenditure_handling/edit');
                        }
            ...
            add: function() {
                ...
                modalTitle.text('Add Data Expenditure Handling');
                Helper.blockElement($(modalBody));
                Helper.ajax(Helper.baseUrl('expenditure_handling/load_add_form'), 'get', 'html')
            ...
            edit: function(e) {
                ...
                t.text("Edit Data Expenditure Handling"), Helper.blockElement($(i)), Helper.ajax(Helper.baseUrl("expenditure_handling/load_edit_form"), "get", "html", {
                    id:e
                }).error(function(e) {
                    a.find(".close").click()
                }).done(function(e) {
            ...
            export1: function() {
                ...
                Helper.blockElement($(modalBody));
                Helper.ajax(Helper.baseUrl('expenditure_handling/load_export1'), 'post', 'html')
            ...
            export_date: function() {
                ...
                Helper.blockElement($(modalBody));
                Helper.ajax(Helper.baseUrl('expenditure_handling/load_export_date'), 'get', 'html')
            ...
            handleTransaction: function() {
                ...
                $("#add_row").click(function(){
                    ...
                    $('#container').append('\
                        ...
                        <td align="center"><input id="item'+count+'" class="form-control item money" name="item[]" type="text"></td>\
                        <td align="center"><input id="deskripsi'+count+'" class="form-control deskripsi money" name="deskripsi[]" type="text"></td>\
                        <td align="center"><input id="harga'+count+'" class="form-control harga money" name="harga[]" type="text"></td>\
                        <td align="center"><input id="jml'+count+'" name="jml[]" class="form-control jml" type="text" placeholder="0"></td>\
                    ...
                    $(document).on('keyup', '#jml'+count, function() {
                        $("#sub_harga"+count).autoNumeric("init", {
                            aSep: ",",
                            aDec: ".",
                            aSign: "",
                            mDec: "0"
