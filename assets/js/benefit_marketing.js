    ...
    Page = function() {
        return {
            ...
            submitForm: function(e, a) {
                if (confirm("Are you sure ?")) {
                    ...
                    if (Helper.validateForm(e, {
                        ...
                        a && (t = Helper.baseUrl("benefit_marketing/edit")), 
            ...
            edit: function(e) {
                ...
                t.text("Edit Data Hotel"), Helper.blockElement($(i)), Helper.ajax(Helper.baseUrl("benefit_marketing/load_edit_form"), "get", "html", {
                    id:e
                }).error(function(e) {
                    a.find(".close").click()
                }).done(function(e) {
