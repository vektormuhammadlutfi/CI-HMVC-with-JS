var addBtn = $("#add-btn"),
    loadData = window.base_url + "marketing/load_data",
    tableID = $("#datatable_ajax"),
    grid = new Datatable,
    urlUpdateStatus = window.base_url + "marketing/delete",
    Page = function() {
        return {
            init: function() {
            ...
            submitForm: function(e, a) {
                ...
                if (Helper.validateForm(e, {
                    ...
                    var t = Helper.baseUrl("marketing/add");
                    a && (t = Helper.baseUrl("marketing/edit")), Helper.blockElement(e.parent()), i.attr("disabled", !0), Helper.ajax(t, "post", "json", Helper.serializeForm(e)).error(function(a) {
            ...
            add: function() {
                ...
                i.text("Add Data Marketing"), Helper.blockElement($(a)), Helper.ajax(Helper.baseUrl("marketing/load_add_form"), "get", "html").error(function(a) {
                    e.find(".close").click()
                }).done(function(e) {
                    a.html(e), Helper.selectField($(".select"));
                    var i = null;
            ...
            edit: function(e) {
                ...
                t.text("Edit Data Marketing"), Helper.blockElement($(i)), Helper.ajax(Helper.baseUrl("marketing/load_edit_form"), "get", "html", {
                    id:e
                }).error(function(e) {
                    a.find(".close").click()
                }).done(function(e) {
