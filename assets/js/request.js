var addBtn = $("#add-btn"),
    loadData = window.base_url + "request/load_data/" + id_jadwal,
    tableID = $("#datatable_ajax"),
    grid = new Datatable,
    urlUpdateStatus = window.base_url + "request/delete",
    Page = function() {
        return {
            init: function() {
            ...
            submitForm: function(e, a) {
                ...
                if (Helper.validateForm(e, {
                    ...
                    var t = Helper.baseUrl("request/add/");
                    a && (t = Helper.baseUrl("request/edit")), Helper.blockElement(e.parent()), i.attr("disabled", !0), Helper.ajax(t, "post", "json", Helper.serializeForm(e)).error(function(a) {
            ...
            add: function() {
                ...
                i.text("Add Data Group Manivest"), Helper.blockElement($(a)), Helper.ajax(Helper.baseUrl("request/load_add_form/"+id_jadwal), "get", "html").error(function(a) {
                    e.find(".close").click()
                }).done(function(e) {
            ...
            edit: function(e) {
                ...
                t.text("Edit Data Request"), Helper.blockElement($(i)), Helper.ajax(Helper.baseUrl("request/load_edit_form"), "get", "html", {
                    id:e
                }).error(function(e) {
                    a.find(".close").click()
                }).done(function(e) {
            ...
            agenda: function(e) {
                ...
                window.location.href = Helper.baseUrl("request_detail/group_manivest/") + e;
