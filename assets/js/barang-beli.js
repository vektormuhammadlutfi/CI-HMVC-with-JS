var addBtn = $("#add-btn"),
    loadData = window.base_url + "barang_beli/load_data",
    tableID = $("#datatable_ajax"),
    grid = new Datatable,
    urlUpdateStatus = window.base_url + "barang_beli/delete",
    Page = function() {
        return {
            init: function() {
            ...
            submitForm: function(e, a) {
                ...
                if (Helper.validateForm(e, {
                    ...
                    var t = Helper.baseUrl("barang_beli/add");
                    a && (t = Helper.baseUrl("barang_beli/edit")), Helper.blockElement(e.parent()), i.attr("disabled", !0), Helper.ajax(t, "post", "json", Helper.serializeForm(e)).error(function(a) {
            ...
            add: function() {
                ...
                i.text("Tambah Data Baggage"), Helper.blockElement($(a)), Helper.ajax(Helper.baseUrl("barang_beli/load_add_form"), "get", "html").error(function(a) {
                    e.find(".close").click()
                }).done(function(e) {
                    a.html(e);
                    var i = null;
            ...
            edit: function(e) {
                ...
                t.text("Edit Data Baggage"), Helper.blockElement($(i)), Helper.ajax(Helper.baseUrl("barang_beli/load_edit_form"), "get", "html", {
                    id:e
                }).error(function(e) {
                    a.find(".close").click()
                }).done(function(e) {
