<?php 
	...
	class M_cabang extends CI_Model 
	{
	    ...
	    var $column_order = array('id_cabang', 'kode_cabang', 'nama_cabang', 'alamat_cabang', 'email_cabang');
	    var $column_search = array('id_cabang', 'kode_cabang', 'nama_cabang', 'alamat_cabang', 'email_cabang');
